...
@section('container')
        ...
        <textarea type="text" name="category_description" class="form-control @error('category_description') is-invalid @enderror" placeholder="Category Description">{{ $category->category_description }}</textarea>
