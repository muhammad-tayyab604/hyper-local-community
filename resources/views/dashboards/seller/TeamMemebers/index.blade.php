                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <div><a href="{{ route('team.create') }}" class="btn btn-primary text-white"
                                                style="float:right; margin:10px;">Add Team Member</a> </div>
                                    ...
                                    <tbody class="projectsTableBody">
                                        ...
                                        @foreach ($teamMembers as $team)
                                            ...
                                            <tr class="">
                                                {{-- {{ dd($product) }} --}}
                                                <td>{{ $i }}</td>
                                                <td> <img src="{{ asset('Image/team/' . $team->image) }}" height="100px"
                                                        width="120px"></td>
                                                ...
                                                <td>{{ $team->team }}</td>
                                                <td>
                                                    <a href="{{ route('team.view', $team->id) }}"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="{{ route('team.edit', $team->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a data-target="#DeleteModal" data-toggle="modal" class="cancel"
                                                        data-id="{{ $team->id }}"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
