...
<li class="nav-item">
	<a href="#servicesAccordion" class="nav-link d-flex align-items-center" data-bs-toggle="collapse">
		<i class="fa fa-house text-lg"></i>
		<p class="text-lg text-white ml-3 mr-3 mb-0">Services</p>
		<i class="fas fa-chevron-down ms-auto"></i>
	</a>

	<ul id="servicesAccordion" class="collapse list-unstyled ms-4">
		<li>
<a href="{{ route('services.index') }}" class="nav-link text-white">
		...
		<li>
<a href="{{ route('service-categories.index') }}" class="nav-link text-white">
