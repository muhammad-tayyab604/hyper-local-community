        ...
        <div class="mainCard pl-5 pr-5 p-12">
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                <div class="card-header">
                    <h3 class="card-title text-lg font-sans">Update Team Memeber</h3>
                </div>
                @if (session('success'))
                ...
                <div class="card-body p-4">
                                    ...
                                    <div class="">
                                        ...
                                        <select name="team"
                                            ...
                                            <option value="Sales Team"
                                                {{ $team->team === 'Sales Team' ? 'selected' : '' }}>Sales Team
                                            </option>
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="submit" name="submit" id="submit" value="Update Team Member"
