...
namespace App\Http\Controllers\dashboardControllers\buyer;
...
class BuyerDashboardController extends Controller
{
    ...
    public function dashboard(InfoFormChart $chart)
    {
        ...
        return view('dashboards.buyer.dashboard', compact('product', 'category', 'subCategory', 'testimonial', 'project', 'blog', 'formData', 'chart', 'user', 'role'));
    }
}
