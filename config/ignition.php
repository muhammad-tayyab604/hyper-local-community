...
return [
    ...
    */
    ...
    'solution_providers' => [
        ...
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\IncorrectValetDbCredentialsSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingAppKeySolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\DefaultDbNameSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\TableNotFoundSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingImportSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\InvalidRouteActionSolutionProvider::class,
        ViewNotFoundSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\RunningLaravelDuskInProductionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingColumnSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\UnknownValidationSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingMixManifestSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingViteManifestSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\MissingLivewireComponentSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\UndefinedViewVariableSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\GenericLaravelExceptionSolutionProvider::class,
        OpenAiSolutionProvider::class,
        SailNetworkSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\UnknownMysql8CollationSolutionProvider::class,
        \Spatie\ErrorSolutions\SolutionProviders\Laravel\UnknownMariadbCollationSolutionProvider::class,
    ],
